...
class QuestionPlanner:
    ...
    def force_answer(self, sub_question: str, context_sentences: List[str]) -> str:
        ...
        try:
            ...
            # additional_str,_ = knowPath(sub_question, self.llm_type)
    ...
    def answer_original_question(self, question: str, sub_results: List[Dict]) -> Dict[str, str]:
        ...
        try:
            ...
            _, additional_info = knowPath(question, self.llm_type)
            # context = get_context(context, additional_info)
            context = "Main Content: " + additional_info + "Additional content : " + context
...
def chain_rag(dataset_name: str, use_cache: bool = True, llm_type="qwen2.5:7b"):
    ...
    # output_dir = Path("knowpath_processed_data") / dataset_name
    output_dir = Path(llm_type) / Path("knowpath_processed_data") / dataset_name
...
if __name__ == "__main__":
    ...
    parser.add_argument("--LLM_type", "-lt", type=str,
                    default="qwen2.5:7b", help="base LLM model.", choices=['qwen2', 
                                                                        'qwen2.5:72b','qwen2.5:32b','qwen2.5', "qwen2.5:14b", 
                                                                        'qwq',
